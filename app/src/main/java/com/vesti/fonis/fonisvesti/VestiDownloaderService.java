 ...
 */
public class VestiDownloaderService extends IntentService {
    ...
    public VestiDownloaderService() {
        super("VestiDownloaderService");
    }
    ...
    private void napraviVesti(String tekstJSON) {
        try {
            ...
            Vesti.brojVesti = sadrzajStrane.getInt("count_total");
    ...
    public void onDestroy() {
        Log.d(Util.TAG, "VestiDownloaderService is stopped.");
        super.onDestroy();
